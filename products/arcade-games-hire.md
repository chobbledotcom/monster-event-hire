...
galleryImages:
  ...
  - /images/uploads/2020/01/pac-man-arcade-game.jpg
  - /images/uploads/2020/01/street-fighter-arcade-game.jpg
...
description: |-
  ...
  **Let’s get this Party started…**
  Choose your favourite Bouncy arcade game to hire  from the list below,
  bringing your arcade Game favourites to our hire fleet.
  Take on our **pack man**, see how long you can last against the ghosts while trying to eat your way around the screen, Can you eat your fill!
  Have a go at the old classic **street fighter**, take on the multitude of different opponents each having there own skill set. Try not to wear your fingers out.
  Take out  the aliens in **Space Invaders**, try to avoid them shooting you while your aiming to progress through the levels of the game.
  All 3 classic games will keep you and your guests amused for hours.
  These are available as an individual arcade game or as a combination of all three games. You may also be interested in:- ,[80’s retro Cocktail table](../../products/cocktail-table-retro-games-machine/), [Atari Pong](../../products/atari-pong-table-hire/) 
  They can go through standard door ways.
  -   Suitable for indoor or marquee use only
  -   Requires 13amp 240V power supply PER GAME
  -   Equipment dimensions 1.5mtrs high x 600mm wide x 600mm deep.
...
body_class: 'wp-singular products-template-default single single-products postid-1984 wp-theme-littlemonsters arcade-games-hire'
article_modified_time: '2025-06-18T09:42:11+00:00'
twitter_data1: '2 minutes'
share_description: 'Arcade Games Hire Arcade games hire, then here at Monster event hire we would love to help you do exactly that. Looking to hire an arcade game? Maybe it’s for a birthday party, a christening'
upsells: 
  - 'buzz-wire'
testimonial_body: |-
  Hi Joanne,
